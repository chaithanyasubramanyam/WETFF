...
export default class Gold_silver extends React.Component{
    constructor(props){
        super(props);
        this.state={
    ...
    render(){
        return(
            <div>
                ...
                <Container className='collarcontent'>
                <Row>
                <Col className='class'>Form</Col>
                <Col className='classdropdown' >
                <select id = 'classdrop'name='Form' onChange={this.handleChange} required>
                <option value=""></option>
                <option value="adfasd">adfasd</option>
                <option value="aaddad">aaddad</option>
                <option value="asfsdf">asfsdf</option>
                ...
                <Container className='collarcontent'>
                <Row>
                <Col className='class'>Gram</Col>
                <Col className='classdropdown' >
                <select id = 'classdrop'name='Gram' onChange={this.handleChange} required>
                <option value=""></option>
                <option value="adfasd">adfasd</option>
                <option value="aaddad">aaddad</option>
                <option value="asfsdf">asfsdf</option>
