...
export default class FDandBonds extends React.Component{
    constructor(props){
        super(props);
        this.state={
    ...
    render(){
        return(
            <div>
                ...
                <Row>
                <Col className='class'>Amt</Col>
                <Col className='classdropdown'>
                <select id = 'classdrop' name='Amt' onChange={this.handleChange} required>
                <option value=""></option>
                ...
                <Container className='collarcontent'>
                <Row>
                <Col className='class'>Interest rate</Col>
                <Col className='classdropdown' >
                <select id = 'classdrop'name='Interest' onChange={this.handleChange} required>
                <option value=""></option>
                <option value="adfasd">adfasd</option>
                <option value="aaddad">aaddad</option>
                <option value="asfsdf">asfsdf</option>
