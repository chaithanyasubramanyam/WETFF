    ...
    render(){
        return(
            <div>
                ...
                <select id = 'classdrop' name='Brand' onChange={this.handleChange} required>
                <option value=""></option>
                ...
                <Col className='classdropdown' >
                <select id = 'classdrop'name='Model' onChange={this.handleChange} required>
                <option value=""></option>
                <option value="adfasd">adfasd</option>
                <option value="aaddad">aaddad</option>
                <option value="asfsdf">asfsdf</option>
                ...
                <Container className='collarcontent'>
                    ...
                    <input type="month" name="Monthyear" className='monthyear' onChange={this.handleChange}
                    required/>
                ...
                <Container className='collarcontent'>
                    ...
                    <input type="submit" className='retrivebtn' onClick={this.retrive1} value='Upload'/>
                ...
                <Container className='collarcontent'>
                    ...
                    <input type="submit" className='retrivebtn' onClick={this.retrive2} value='Upload'/>
