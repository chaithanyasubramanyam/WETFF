    ...
    render(){
        return(
            <div>
                ...
                <Row>
                <Col className='class'>Type of acc</Col>
                ...
                <Container className='collarcontent'>
                <Row>
                <Col className='class'>Investment Time</Col>
                <Col className='classdropdown' >
                <select id = 'classdrop'name='Time' onChange={this.handleChange} required>
                <option value=""></option>
                <option value="adfasd">adfasd</option>
                <option value="aaddad">aaddad</option>
                <option value="asfsdf">asfsdf</option>
                ...
                <Container className='collarcontent'>
                   ...
                   Investment horizon
                    ...
                    <input type="month" name="Monthyear" onChange={this.handleChange} className='monthyear'
                    required/>
