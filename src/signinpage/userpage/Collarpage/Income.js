    ...
    render(){
        return(
            <div>
                ...
                <Row>
                <Col className='class'>Co Industry</Col>
                <Col className='classdropdown'>
                <select id = 'classdrop' name='Coi' onChange={this.handleChange} required>
                <option value=""></option>
                ...
                <Container className='collarcontent'>
                <Row>
                <Col className='class'>Income</Col>
                <Col className='classdropdown' >
                <select id = 'classdrop'name='Income' onChange={this.handleChange} required>
                <option value=""></option>
                <option value="adfasd">adfasd</option>
                <option value="aaddad">aaddad</option>
                <option value="asfsdf">asfsdf</option>
                ...
                <Container className='collarcontent'>
                <Row>
                <Col className='class'>Last year income</Col>
                <Col className='classdropdown' >
                <select id = 'classdrop'name='Lincome' onChange={this.handleChange} required>
                <option value=""></option>
                <option value="adfasd">adfasd</option>
                <option value="aaddad">aaddad</option>
                <option value="asfsdf">asfsdf</option>
